                            ...
                            <table class="table align-middle table-hover table-borderless foy-table">
                                <thead>
                                    <tr class="foy-acastry-tr">
                                        ...
                                        <th width="13%" scope="col" class="text-center foy-th-heading">TMark</th>
                                        <th width="13%" scope="col" class="text-center foy-th-heading">IMark</th>
                                        <th scope="col"></th>
                                    </tr>
                                </thead>
                                @php
                                    ...
                                    <tr class="">
                                        <td  class="ps-4">
                                            ...
                                            <p class="foy-p">{{ $member->user->name }}
                                                @foreach($classroomIndustryWork->stars as $star)
                                        ...
                                        @if ($submissions->count()>0)
                                            ...
                                            @else
                                                ...
                                                <td>
                                                    <input class="form-control"  placeholder="{{ '/'.$industryWork->points }}" type="number" readonly>
                                                </td>
                                                <td>
                                                    <input class="form-control" placeholder="{{ '/'.$industryWork->points }}" type="number" readonly>
                                                </td>
                                            ...
                                            <div class="more mx-3 dropdown">
                                                ...
                                                <ul class="dropdown-menu p-0" aria-labelledby="dropdownMenuButton1">
                                                    @php
                                                        $str=0;
                                                    @endphp
                                                    @if($classroomIndustryWork->stars->count()>0)
                                                        @foreach($classroomIndustryWork->stars as $star)
                                                            @if($star->star_id == $member->id)
                                                                @php
                                                                    $str=1;
                                                    ...
                                                    @if ($str==0)
                                                        <li>
                                                            <a class="dd-item dropdown-item py-2 border-bottom" href="/classIndustryStar/{{ $member->id }}/{{ $classroomIndustryWork->id }}/{{ $classroom->id }}">Make Star</a>
                                                        </li>
                                                    @else
                                                        <li>
                                                            <a class="dd-item dropdown-item py-2 border-bottom" href="/classIndustryStarRemove/{{ $member->id }}/{{ $classroomIndustryWork->id }}/{{ $classroom->id }}">Remove Star</a>
                                                        </li>
                                                    @endif
                        ...
                        <div class="row">
                            @foreach($submissions as $submission)
                                @foreach($submission->iwsAttachment as $attachment)
                                    @include('components.classIndustrySubmission.industrySubmissionList')
                                @break
                                @endforeach
                            @endforeach
                        </div>
