...
<ul class="nav nav-pills foy-nav-pills">
    <li class="nav-item foy-nav-item ">
      <a class="nav-link foy-nav-link active" aria-current="page" href="#"><i class="fa-brands fa-steam"></i> Stream</a>
    </li>
    <li class="nav-item foy-nav-item">
      <a class="nav-link foy-nav-link" href="#"><i class="fa-solid fa-book-bookmark"></i> Classwork</a>
    </li>
    <li class="nav-item foy-nav-item">
