...
<section class="main-content mb-5">
  <div class="container">
    ...
    <div class="row">
        ...
        <!-- industry-card-start -->
        @if($classroomIndustryWorks->count()>0)
        @foreach($classroomIndustryWorks as $classroomIndustryWork)
        <?php $industryWork = $classroomIndustryWork->industryWork ?>
        <div class="industry-card p-4 my-3">
          ...
          <a href="/classIndustrySubmit/{{ $classroomIndustryWork->id }}" type="button" class="text-decoration-none btn announce-b2 px-3 my-2">
            View Details
          </a>
        </div>
        @endforeach
