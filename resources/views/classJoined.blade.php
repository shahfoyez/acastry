        ...
        <div class="row ">
            ...
            <div class="col-sm-12 col-md-6 col-xl-4 my-4 ">
                <div class="card h-100  bg-body col-12" style="border-radius: 15px;">
                    ...
                    <a href="/classroomStream/{{ $classroom->id }}" class="text-decoration-none foy-link1"><h5>{{  Illuminate\Support\Str::limit( $classroom->name, 35, ' ...'); }} </h5></a>
                        ...
                        <div class="d-flex justify-content-between">
                            <div class="d-flex align-items-center fot-cIndustries">
                                ...
                                @if($classroom->classroomIndustryWork->count() > 3)
                                    <span class="font-weight-bold id-title-dt ps-4" style="font-size: 12px;">+more</span>
                                @endif
                            </div>
