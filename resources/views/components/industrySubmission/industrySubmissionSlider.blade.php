<!-- start:slider -->
@if($industryWork->industryWorkAttachment->count()>0)
<div id="carouselControl{{ $industryWork->id }}" class="carousel slide px-2" data-bs-interval="false">
    <div class="carousel-inner">
    <?php
            $chunks= $industryWork->industryWorkAttachment->chunk(5);
            $i=0;
    ...
    @if($industryWork->industryWorkAttachment->count()>5)
        <a class="carousel-control-next next-width" href="#carouselControl{{ $industryWork->id }}" role="button"  data-bs-slide="next">
