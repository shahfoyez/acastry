<div class='col-sm-4 foy-as-RearangeBox foy-as-imgThumbContainer'>
    <div class='foy-as-head'>
            ...
            <div>
            <a class="text-decoration-none" href="/classIndustrySubmissionSingle/{{ $submission->user->id }}/{{ $industryWork->id }}/{{ $classroom->id }}/{{ $submission->id }}"><p class='foy-as-attachment'>{{ $submission->iwsSubmissionAttachment->count() }} attachments</p></a>
            </div>
    </div>
