<div class='col-sm-4 foy-as-RearangeBox foy-as-imgThumbContainer'>
    <div class='foy-as-head'>
            ...
            <div>
            <a class="text-decoration-none" href="/industrySubmissionSingle/{{ $submission->user->id }}/{{ $industryWork->id }}/{{ $submission->id }}"><p class='foy-as-attachment'>{{ $submission->iwsSubmissionAttachment->count() }} attachments</p></a>
            </div>
    </div>
