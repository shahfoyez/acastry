    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="">
                    <div class="p-2 m-2">
                        <input type="text" id="fname" class="p-2 pe-0 m-2 ms-0"name="fname" placeholder="Topic" style="width:100%; background:#e9f8ff; border:none">        
                    </div>
                    ...
                    <div class="announce-postm-2 me-4 text-end">
                        ...
                        <button type="button" class="btn announce-b2 px-3">Add</button>
                    </div>
                </form>
            </div>
        </div>
